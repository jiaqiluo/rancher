...
type Manager interface {
	...
	Ensure(namespace, releaseName, chartName, minVersion, exactVersion string, values map[string]interface{}, takeOwnership bool, installImageOverride string) error
