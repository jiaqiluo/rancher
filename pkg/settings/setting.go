...
var (
	...
	SystemAgentInstallScript            = NewSetting("system-agent-install-script", "https://github.com/jiaqiluo/system-agent/releases/download/v0.15.2-rc1/install.sh") // To ensure consistency between SystemAgentInstallScript default value and CATTLE_SYSTEM_AGENT_INSTALL_SCRIPT to utilize the local system-agent-install.sh script when both values are equal.
	WinsAgentInstallScript              = NewSetting("wins-agent-install-script", "https://raw.githubusercontent.com/rancher/wins/v0.16.0-rc.4/install.ps1")
	...
	MachineProvisionImage               = NewSetting("machine-provision-image", "rancher/machine:v0.15.0-rancher146-rc.2")
